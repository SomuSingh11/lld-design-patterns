package behavioral.state.vendingMachine.naive;

// States -> IdleState | ItemSelectedState | HasMoneyState | DispensingState
// User Facing Operations -> selectItem | insertCoin | dispenseItem
    ...
    public void selectItem(String itemCode){
        switch (currentState){
            ...
            case ITEM_SELECTED:
                ...
                break;
            case HAS_MONEY:
                System.out.println("Payment already received for the item");
                break;
            case DISPENSING:
